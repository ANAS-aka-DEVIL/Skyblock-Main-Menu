...
class Main extends PluginBase implements Listener {
  ...
  public function onEnable() : void {
    ...
    $this->getLogger()->info("SBMenuUI By Devil Is Now Enabled ✅");
  ...
  public function ccsbmenu(Player $player) {
    ...
    $form = $this->getServer()->getPluginManager()->getPlugin("FormAPI")->createSimpleForm(function (Player $player, int $data = null){
      ...
      switch($data){
        ...
        case 2:
            ...
            $this->getServer()->dispatchCommand($player, "skill");
        ...
        case 8:
            ...
            $this->getServer()->dispatchCommand($player, "vaultui");
        ...
        case 12:
            ...
            $this->getServer()->dispatchCommand($player, "warpui");
       ...
       // case 13:
          ...
          //    if($sender->hasPermission("settings.form")){
    ...
    //   break;
      ...
      $form->addButton("§l§bISLAND MENU\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/8170/8170934.png");

      $form->addButton("§l§bYOUR PROFILE\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/2534/2534204.png");

      $form->addButton("§l§bSKILLS MENU\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/1207/1207390.png");

      $form->addButton("§l§bRECIPES BOOK\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/1041/1041373.png");

      $form->addButton("§l§bSHOP MENU\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/9423/9423832.png");

      $form->addButton("§l§bQUEST MENU\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/8560/8560006.png");

      $form->addButton("§l§bKIT MENU\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/4230/4230567.png");

      $form->addButton("§l§bJOB MENU\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/1694/1694787.png");

      $form->addButton("§l§bENDER CHEST\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/1959/1959478.png");

      $form->addButton("§l§bAUCTION HOUSE\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/9235/9235046.png");

      $form->addButton("§l§bBANK MENU\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/2398/2398987.png");

      $form->addButton("§l§bBAZAAR MENU\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/3485/3485870.png");

      $form->addButton("§l§bFAST TRAVEL\n§r§l§d» §r§8Tap To Open", 1, "https://cdn-icons-png.flaticon.com/512/9367/9367341.png");
